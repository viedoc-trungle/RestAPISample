...
{
    [Route("api/v2/teabreaks")]
    public class TeaBreaksV2Controller : ControllerBase
    {
        private readonly TeabreakRepository _teabreakRepository;
        private readonly ProviderRepository _providerRepository;

        public TeaBreaksV2Controller(TeabreakRepository teabreakRepository, ProviderRepository providerRepository)
        {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPut("{id}", Name = "ReplaceTeaBreakV2")]
        [ProducesResponseType(typeof(TeaBreak), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        ...
        /// <returns></returns>
        [HttpPatch("{id}", Name = "EditTeaBreakV2")]
        [ProducesResponseType(typeof(TeaBreak), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPost("{id}/orders", Name = "AddOrderV2")]
        [ProducesResponseType(typeof(TeaBreak), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
